classdef ImagemMainFigure < handle
%IMAGEMMAINFIGURE  One-line description here, please.
%
%   output = ImagemMainFigure(input)
%
%   Example
%   ImagemMainFigure
%
...
methods
    function this = ImagemMainFigure(gui, img)
        this.gui = gui;
        this.image = img;
...
%         end
    ...
    function updateTitle(this)
        ...
        titlePattern = 'ImageSlicer - %s [%d x %d x %d %s] - %g:%g';
